...
namespace Vsite.CSharp.DogađajiDelegati
{
    ...
    {
       // public event EventHandler Alarm; // 060
        public event AlarmEventHandler Alarm;

        public delegate void AlarmEventHandler(object sender, AlarmEventArgs a); // 066
        ...
        public void DižiAlarm(string mjesto, int razina, string opis)
        {
            ...
            // OnAlarm(EventArgs.Empty); // 061
            OnAlarm(new AlarmEventArgs(mjesto, razina, opis)); // 067
        }
    }
}
