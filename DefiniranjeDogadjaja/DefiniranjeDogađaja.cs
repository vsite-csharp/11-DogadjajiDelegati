...
namespace Vsite.CSharp.DogađajiDelegati
{
    class DefiniranjeDogađaja
    {
        static void Main(string[] args)
        {
            ...
            // :063a Otkomentirati donju naredbu tako da se slušatelj može predbilježiti na događaj Alarm. Pokrenuti program i pogledati ispis.
            ga.Alarm += sa.AlarmNotification;
            ...
            // :063b Otkomentirati donju naredbu tako da se slušatelj može odjaviti od događaja Alarm. Pokrenuti program i pogledati ispis.
            ga.Alarm -= sa.AlarmNotification;
