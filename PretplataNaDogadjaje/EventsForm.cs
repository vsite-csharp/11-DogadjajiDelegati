...
namespace Vsite.CSharp.DogađajiDelegati
{
    public partial class EventsForm : Form
    {
        public EventsForm()
        {
            ...
            textBox.TextChanged += TextBox_TextChanged; // 001
        }

        private void TextBox_TextChanged(object sender, EventArgs e)
        {
            buttonDelete.Enabled = textBox.TextLength != 0; //buttonDelete => disabled ako ništa ne piše (002)
        }

        private void buttonDelete_Click(object sender, EventArgs e)
        {
            textBox.Clear(); // 004 => buttonDelete briše tekst unutar textBox-a
        }
