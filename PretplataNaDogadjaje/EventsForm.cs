...
namespace Vsite.CSharp.DogađajiDelegati
{
    public partial class EventsForm : Form
    {
        ...
        {
            InitializeComponent();
            buttonDelete.Enabled = false;                       //inicijalno disablamo delet tipku i kad nesto upisemo se enablea i obrnuto
            textBox.TextChanged += TextBox_TextChanged;  
        }

        private void TextBox_TextChanged(object sender, EventArgs e)
        {
            buttonDelete.Enabled = textBox.TextLength != 0;                 //omogućavamo gumbu delete da se na njega moze kliknuti samo kad je teks upisan u textbox
        }
