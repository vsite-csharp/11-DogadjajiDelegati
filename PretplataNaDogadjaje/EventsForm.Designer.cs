namespace Vsite.CSharp.DogađajiDelegati
{
	partial class EventsForm
	{
		...
		private void InitializeComponent()
		{
			...
			buttonDelete.Location = new Point(266, 39);
			buttonDelete.Margin = new Padding(4);
			buttonDelete.Name = "buttonDelete";
			buttonDelete.Size = new Size(88, 28);
			...
			buttonClose.Location = new Point(266, 171);
			buttonClose.Margin = new Padding(4);
			buttonClose.Name = "buttonClose";
			buttonClose.Size = new Size(88, 28);
