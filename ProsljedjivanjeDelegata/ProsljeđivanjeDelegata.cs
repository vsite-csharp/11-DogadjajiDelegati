...
namespace Vsite.CSharp.DogađajiDelegati
{
    ...
    class ProsljeđivanjeDelegata
    {
        ...
        public static void IspisFunkcijeSinus()
        {
            ...
            Funkcija funkcija = new Funkcija(Math.Sin);
            IspišiFunkciju(funkcija, 0.0, Math.PI, 10);
        ...
        public static void IspisFunkcijeE()
        {
            ...
            Funkcija funkcija = new Funkcija(Math.Exp);
            IspišiFunkciju(funkcija, 0, 10, 5);
            //  Pokrenuti program i provjeriti ispis
        }

        //  Pokrenuti i provjeriti testove (2 testa u grupi "ProsljeđivanjaDelegata" moraju proći).
