...
namespace Vsite.CSharp.DogađajiDelegati
{
    public partial class KodDvaBotuna : Form
    {
        ...
        // :082 Napraviti klasu MyButton koja će biti izvedena iz klase Button,
        // u njoj nadglasati virtualnu metodu OnClick te unutar metode dodati prikaz kontrole MessageBox.
    ...
    public class MyButton : Button
    {
        ...
        {
            //base.OnClick(e);
            MessageBox.Show("Kliknuo si me!", "Moj botun iz vanjske");
        }
    }
}
