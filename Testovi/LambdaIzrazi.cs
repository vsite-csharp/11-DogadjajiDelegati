namespace Vsite.CSharp.DogađajiDelegati.Testovi
{
    ...
    public class LambdaIzrazi
    {
        ...
        public void MetodaKorijenujČlanoveVraćaNizKorijenovanihBrojeva()
        {
            ...
            var rezultat = Vsite.CSharp.DogađajiDelegati.LambdaIzrazi.KorijenujČlanoveNiza(niz).ToArray();
        ...
        {
            double[] niz = new double[] { 0, 1, 2, 3, 4 };
            var rezultat = Vsite.CSharp.DogađajiDelegati.LambdaIzrazi.KvadrirajČlanoveNiza(niz).ToArray();
            Assert.AreEqual(0.0, rezultat[0], 1e-5);
            Assert.AreEqual(1.0, rezultat[1], 1e-5);
        ...
        public void MetodaKapitalizirajVraćaSVelikimSlovima()
        {
            ...
            var rezultat = Vsite.CSharp.DogađajiDelegati.LambdaIzrazi.Kapitaliziraj(niz).ToArray();
